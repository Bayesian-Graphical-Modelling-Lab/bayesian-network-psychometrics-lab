...
publication_types : ["6"]
publication: "Marsman, M., Tanis, C., Bechger, T. M., & Waldorp, L. J. (2019). Network psychometrics in educational
practice. Maximum likelihood estimation of the Curie-Weiss model. In Theoretical and Practical Advances
in Computer-Based Educational Measurement (pp. 93–120). Springer Nature."
